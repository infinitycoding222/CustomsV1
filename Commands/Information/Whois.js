...
module.exports = class extends Command {
    ...
    async run(message, args) {
        ...
        let embed2 = new MessageEmbed()
            ...
            .addField(`Hoist Role`, member.roles.hoist.name, true)
            .addField(`Activity`, member.presence.activities.map(x => x).join(", ") || "Not Playing", true)
            .addField(`Flags / Badges`, userFlags.map(flag => flags[flag]).join(', ') || "None")
